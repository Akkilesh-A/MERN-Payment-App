  ...
  return (
    <div className='flex flex-col h-[100vh] items-center justify-center'>
        <div className='bg-white flex flex-col sm:px-16 p-8  rounded-md shadow '>   
            ...
            <button className='border py-2 mt-6 bg-black text-white rounded-md font-bold mx-8'>Sign In</button>
            <p className='text-gray-500 font-[1.5rem] mt-4'>Already have an account? <a href=""></a></p>
        </div>       
    </div>
  )
}
